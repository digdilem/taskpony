                ...
                for my $key (keys %$config) {
                    ...
                    if ($new_val) {
                        ...
                        if ($key eq 'cfg_include_datatable_buttons') {
                            $new_val = 0;
                            debug("Belay that, this is a checkbox, set it at 0");
                            } else {
                            $new_val = $config->{$key};
                            }
                        }
                         ...
                         <form method="post" action="/config" style="display:inline;">
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <input class="form-check-input" type="checkbox" name="cfg_include_datatable_buttons" 
                                    ...
                                    if ($config->{cfg_include_datatable_buttons} == 1) { $retstr .= " checked "; }
                            ...
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                ...
                                &nbsp;&nbsp;
                                <span class="badge bg-~ . $config->{cfg_header_colour} . qq~">Currently '$config->{cfg_header_colour}'</span>
                                </span>
                                <div class="mb-3">
...
sub initialise_database { 
    ...
    $dbh->do(q~
        ...
        ('cfg_header_colour', '$cfg_header_colour')
        ;
...
sub header { 
    ...
    $retstr .= qq~
            ...
            <div>
                ...
                &nbsp;
                <a href="/config" class="btn btn-secondary btn"><i class="fa-solid fa-gear"></i></a>
            </div>
            </h3>
        </div>
    </div>
...
sub footer { # Return standard HTML footer
    ...
    $retstr .= qq~
        <footer class="mt-auto text-white-50 text-center">
            <p>$app_title v.$app_version by <a href="https://digdilem.org/" class="text-white">Digital Dilemma</a>. </p>
        </footer>
        </div>
